...
plt.plot(frequency_plot_2b/1e9,smooth_d2/np.max(smooth_d2),color="blue",label="Second Derivative")
...
plt.plot(frequency_plot_3/1e9,smooth_d2/np.max(smooth_d2),color="blue",label="Second Derivative")
...
plt.plot(frequency_plot_4/1e9,smooth_d2/np.max(smooth_d2),color="blue",label="Second Derivative")
