...
large_sigma_err = np.zeros(4)

fine_freq_1 = np.zeros((4,6))
fine_freq_1_err = np.zeros((4,6))

fine_freq_2 = np.zeros((4,6))
fine_freq_2_err = np.array([[0.003,0.003,0.003,0.003,0.003,0.003],[0.003,0.003,0.003,0.003,0.003,0.003],[0.003,0.003,0.003,0.003,0.003,0.003],[0.003,0.003,0.003,0.003,0.003,0.003]])
...
plt.ylabel("Transmission (V)",size=20)
plt.title("Whole Spectrum", size=24)
...
ax.plot(freq/1e9,C1_freq,color="Orange",label="With Pump")
ax.plot(freq/1e9,C2_freq,color="Blue",label="Without Pump")
...
trial_range = results.loc[(results[0] > 0) & (results[0] < 0.09)]
...
frequency_trial = freq[0:len(trial_range[0])]

rcParams["font.family"] = 'Times New Roman'
rcParams['mathtext.fontset'] = 'cm'

fig, ax = plt.subplots(figsize=(10,6))
#plt.plot(frequency_trial/1e9,two_gauss(trial,*popt_whole))
plt.plot(frequency_trial/1e9,gauss_function(trial,*popt_whole[0:2],*popt_whole[5:]),label="87Rb F=2 Fit",color="blue")
plt.plot(frequency_trial/1e9,gauss_function(trial,*popt_whole[3:]),label="85Rb F=3 Fit",color="red")
plt.plot(frequency_trial/1e9,trial_range[2],label="Doppler Broadened Data",color="orange")
ax.axis(True)
sns.set(style="ticks")
ax.grid(True, which='both')
ax.margins(x=0)
...
plt.yticks(size=18,color='#4f4e4e')
sns.set(style='whitegrid')
plt.title("Peaks 1 and 2", size=24)
plt.show()

double_loc = np.array([popt_whole[1],popt_whole[4]])
double_loc_err = np.array([np.sqrt(pcov_whole[1][1]),np.sqrt(pcov_whole[4][4])])
double_freq = np.zeros(2)
double_freq_err = np.zeros(2)
double_sigma = np.zeros(2)
double_sigma_err = np.zeros(2)

for i in range(2):
    index = (np.abs(trial_range[0] - double_loc[i])).argmin()
    double_freq[i] = freq[index]
    double_freq_err[i] = double_freq[i]*double_loc_err[i]/double_loc[i]
    index = (np.abs(trial_range[0] - popt_whole[1+i*3] - popt_whole[2+i*3])).argmin()
    double_sigma[i] = - double_freq[i] + freq[index]
    double_sigma_err[i] = double_sigma[i] * np.sqrt(pcov_whole[2+3*i][2+3*i])/popt_whole[2+3*i]
...
plt.xlabel("Relative Frequency (GHz)",size=20)
plt.ylabel("Transmission (V)",size=20)
plt.title("Peak 1: Rb87 F=2", size=24)
plt.legend(fancybox=True, shadow=True, prop={'size': 18})
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
sns.set(style='whitegrid')
...
large_freq_err[0] = large_freq[0]*large_time_err[0]/large_time[0]
index = (np.abs(first_peak[0] - popt1[1] - popt1[2])).argmin()
large_sigma[0] = - large_freq[0] + freq[17991+index]
large_sigma_err[0] = large_sigma[0] * np.sqrt(pcov1[2][2])/popt1[2]
print(large_freq[0])
...
fig, ax = plt.subplots(figsize=(10,6))
ax.plot(frequency_plot_1/1e9,first_peak[3],color="Blue",label="Doppler Free")
...
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
plt.title("Peak 1: Rb87 F=2; Method 1 (Lorentzians)", size=24)
sns.set(style='whitegrid')
plt.show()
...
rcParams['mathtext.fontset'] = 'cm'
fig, ax = plt.subplots(figsize=(10,6),dpi=300)
ax.plot(frequency_plot_1b/1e9,new_splice[3],color="Orange",label="Doppler Free")
...
plt.axvspan((frequency_plot_1b[peaks[0]]/1e9)-0.003,(frequency_plot_1b[peaks[0]]/1e9)+0.003,color="Blue",alpha=0.1)
for i in range(1,7):
    if i == 5:
        plt.axvline(frequency_plot_1b[peaks[i]]/1e9,color="Blue",alpha=0.5,linestyle="dashed")
    else:
        plt.axvspan((frequency_plot_1b[peaks[i]]/1e9)-0.003,(frequency_plot_1b[peaks[i]]/1e9)+0.003,color="Blue",alpha=0.1)
...
plt.xlabel("Relative Frequency (GHz)",size=20)
# plt.legend(fancybox=True, shadow=True, prop={'size': 14},loc="upper right")
ax.axis(True)
sns.set(style="ticks")
ax.grid(True, which='both')
ax.margins(x=0)
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
plt.title("Peak 1: Rb87 F=2; Method 2: Derivatives", size=24)
sns.set(style='whitegrid')
plt.show()

peaks = np.delete(peaks,5)

fine_freq_2[0] = freq[[peaks+19635]]
...
plt.ylabel("Transmission (V)",size=20)
plt.title("Peak 2: Rb85 F=3", size=24)
plt.legend(fancybox=True, shadow=True, prop={'size': 18})
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
sns.set(style='whitegrid')
...
large_freq_err[1] = large_freq[1]*large_time_err[1]/large_time[1]
index = (np.abs(second_peak[0] - popt2[1] - popt2[2])).argmin()
large_sigma[1] = -large_freq[1] + freq[37727+index]
large_sigma_err[1] = large_sigma[1] * np.sqrt(pcov2[2][2])/popt2[2]
...
plt.xlabel("Something (s)",size=20)
plt.ylabel("Transmission (V)",size=20)
plt.title("Peak 2, Method 1", size=24)
plt.legend(fancybox=True, shadow=True, prop={'size': 18})
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
sns.set(style='whitegrid')
...
plt.xlabel("Something (s)",size=20)
plt.ylabel("Transmission (V)",size=20)
plt.title("Peak 2, Method 2 Trial", size=24)
plt.legend(fancybox=True, shadow=True, prop={'size': 14},loc="upper right")
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
sns.set(style='whitegrid')
...
smooth = gaussian_filter1d(new_splice[3], 60)
smooth_d1 = np.gradient(smooth)
smooth_d2 = np.gradient(smooth_d1)

peaks, _ = find_peaks(-smooth_d2, distance=340)

frequency_plot_2b = freq[37727:37727+len(new_splice[0])]

rcParams["font.family"] = 'Times New Roman'
rcParams['mathtext.fontset'] = 'cm'
fig, ax = plt.subplots(figsize=(10,6),dpi=300)
ax.plot(frequency_plot_2b/1e9,new_splice[3],color="Orange",label="Doppler Free")
plt.plot(frequency_plot_2b/1e9,smooth_d2/np.max(smooth_d2),color="red",label="Second Derivative")
plt.axvline(frequency_plot_2b[peaks[0]]/1e9,color="Blue",label="Identified Peaks",linestyle="dashed")
plt.axvspan((frequency_plot_2b[peaks[0]]/1e9)-0.003,(frequency_plot_2b[peaks[0]]/1e9)+0.003,color="Blue",alpha=0.1)
for i in range(1,len(peaks)):
    plt.axvspan((frequency_plot_2b[peaks[i]]/1e9)-0.003,(frequency_plot_2b[peaks[i]]/1e9)+0.003,color="Blue",alpha=0.1)
    plt.axvline(frequency_plot_2b[peaks[i]]/1e9,color="Blue",linestyle="dashed")
...
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
plt.title("Peak 2, Method 2 Proper", size=24)
sns.set(style='whitegrid')
plt.show()
...
popt3, pcov3 = sp.optimize.curve_fit(gauss_function, third_peak[0], third_peak[2], p0 = [-1, 0.095, 0.01, 0,0],bounds=((-3,-np.inf,-np.inf,-np.inf,0), (0,np.inf,np.inf,np.inf,30)),maxfev=10000)
...
plt.xlabel("Something (s)",size=20)
plt.ylabel("Transmission (V)",size=20)
plt.title("Peak 3: Rb85 F=2", size=24)
plt.legend(fancybox=True, shadow=True, prop={'size': 18})
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
sns.set(style='whitegrid')
...
large_freq_err[2] = large_freq[2]*large_time_err[2]/large_time[2]
index = (np.abs(third_peak[0] - popt3[1] - popt3[2])).argmin()
large_sigma[2] = -large_freq[2] + freq[82135+index]
large_sigma_err[2] = large_sigma[2] * np.sqrt(pcov3[2][2])/popt3[2]
...
plt.xlabel("Something (s)",size=20)
plt.ylabel("Transmission (V)",size=20)
plt.title("Peak 3 Method 2 Trial", size=24)
plt.legend(fancybox=True, shadow=True, prop={'size': 18})
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
sns.set(style='whitegrid')
...
frequency_plot_3 = freq[82793:82793+len(new_splice[0])]

rcParams["font.family"] = 'Times New Roman'
rcParams['mathtext.fontset'] = 'cm'
fig, ax = plt.subplots(figsize=(10,6),dpi=300)
ax.plot(frequency_plot_3/1e9,new_splice[3],color="Orange",label="Doppler Free")
plt.plot(frequency_plot_3/1e9,smooth_d2/np.max(smooth_d2),color="red",label="Second Derivative")
plt.axvline(frequency_plot_3[peaks[0]]/1e9,color="Blue",label="Identified Peaks",linestyle="dashed")
plt.axvspan((frequency_plot_3[peaks[0]]/1e9)-0.003,(frequency_plot_3[peaks[0]]/1e9)+0.003,color="Blue",alpha=0.1)
for i in range(1,6):
    plt.axvspan((frequency_plot_3[peaks[i]]/1e9)-0.003,(frequency_plot_3[peaks[i]]/1e9)+0.003,color="Blue",alpha=0.1)
    plt.axvline(frequency_plot_3[peaks[i]]/1e9,color="Blue",linestyle="dashed")
#plt.scatter(new_splice[0][114372+peaks],smooth_d2[peaks]/np.max(smooth_d2),color="blue",label="Minimum Points")
plt.xlabel("Relative Frequency (GHz)",size=20)
plt.ylabel("y axis",size=20)
plt.title("Peak 3, Method 2 Proper", size=24)
plt.legend(fancybox=True, shadow=True, prop={'size': 14},loc="upper right")
ax.axis(True)
sns.set(style="ticks")
ax.grid(True, which='both')
...
plt.xlabel("Relative Frequency (GHz)",size=20)
plt.ylabel("Transmission (V)",size=20)
plt.title("Peak 4: Rb87 F=1", size=24)
plt.legend(fancybox=True, shadow=True, prop={'size': 18})
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
sns.set(style='whitegrid')
...
large_freq_err[3] = large_freq[3]*large_time_err[3]/large_time[3]
index = (np.abs(fourth_peak[0] - popt4[1] - popt4[2])).argmin()
large_sigma[3] = -large_freq[3] + freq[113385+index]
large_sigma_err[3] = large_sigma[3] * np.sqrt(pcov4[2][2])/popt4[2]
...
plt.xlabel("x axis",size=20)
plt.ylabel("y axis",size=20)
plt.title("Peak 4 Method 2 Trial", size=24)
plt.legend(fancybox=True, shadow=True, prop={'size': 18})
ax.axis(True)
sns.set(style="ticks")
ax.grid(True, which='both')
...
frequency_plot_4 = freq[114372:114372+len(new_splice[0])]

rcParams["font.family"] = 'Times New Roman'
rcParams['mathtext.fontset'] = 'cm'
fig, ax = plt.subplots(figsize=(10,6),dpi=300)
ax.plot(frequency_plot_4/1e9,new_splice[3],color="Orange",label="Doppler Free")
plt.plot(frequency_plot_4/1e9,smooth_d2/np.max(smooth_d2),color="red",label="Second Derivative")
plt.axvline(frequency_plot_4[peaks[0]]/1e9,color="Blue",label="Identified Peaks",linestyle="dashed")
plt.axvspan((frequency_plot_4[peaks[0]]/1e9)-0.003,(frequency_plot_4[peaks[0]]/1e9)+0.003,color="Blue",alpha=0.1)
for i in range(1,6):
    plt.axvspan((frequency_plot_4[peaks[i]]/1e9)-0.003,(frequency_plot_4[peaks[i]]/1e9)+0.003,color="Blue",alpha=0.1)
    plt.axvline(frequency_plot_4[peaks[i]]/1e9,color="Blue",linestyle="dashed")
#plt.scatter(new_splice[0][114372+peaks],smooth_d2[peaks]/np.max(smooth_d2),color="blue",label="Minimum Points")
plt.xlabel("Relative Frequency (GHz)",size=20)
plt.ylabel("y axis",size=20)
# plt.legend(fancybox=True, shadow=True, prop={'size': 18})
...
ax.grid(True, which='both')
ax.margins(x=0)
plt.title("Peak 4: Method 2 Proper", size=24)
plt.xticks(size=18,color='#4f4e4e')
plt.yticks(size=18,color='#4f4e4e')
sns.set(style='whitegrid')
plt.show()
...
print("Amplitude")
print(large_freq)
print(large_freq_err)
print("Width")
print(large_sigma)
print(large_sigma_err)
print("Double")
print("Amplitude")
print(double_freq)
print(double_freq_err)
print("Width")
print(double_sigma)
print(double_sigma_err)
