...
ax.plot(x_initial,difference,color="Orange",label="Difference")
ax.axis(True)
sns.set(style="ticks")
...
ax.plot(freq,difference_freq,color="Orange",label="Difference")
ax.axis(True)
sns.set(style="ticks")
ax.grid(True, which='both')
ax.margins(x=0)
...
popt2, pcov2 = sp.optimize.curve_fit(gauss_function, second_peak[0], second_peak[2], p0 = [-1, 0.0825, 0.01,0,0],bounds=((-np.inf,-np.inf,-np.inf,-np.inf,-np.inf), (0,np.inf,np.inf,np.inf,np.inf)),maxfev=10000)
...
popt3, pcov3 = sp.optimize.curve_fit(gauss_function, third_peak[0], third_peak[2], p0 = [-1, 0.095, 0.01, 0,0],bounds=((-np.inf,-np.inf,-np.inf,-np.inf,-np.inf), (0,np.inf,np.inf,np.inf,np.inf)),maxfev=10000)
...
popt4, pcov4 = sp.optimize.curve_fit(gauss_function, fourth_peak[0], fourth_peak[2], p0 = [-1, 0.105, 0.001, 0,0],bounds=((-np.inf,-np.inf,-np.inf,-np.inf,-np.inf), (0,np.inf,np.inf,np.inf,np.inf)),maxfev=10000)
